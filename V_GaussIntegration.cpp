              ...
              switch (node_id)
              {
                ...
                case 7:
                {
                  ...
                  dndy2GaussPts[ife][node_id] =
                    0.125 * sign_node_y2 * y1_term * y3_term * y123_temp +
                    0.125 * y1_term * y2_term * y3_term * sign_node_y2;
                  dndy3GaussPts[ife][node_id] =
                    0.125 * sign_node_y3 * y1_term * y2_term * y123_temp +
  ...
  double dndy1_at_nodes[][maxNumberNodes], double dndy2_at_nodes[][maxNumberNodes])
{
  ...
  for (i = 0; i < numberNodes; i++)
  {
    switch (i)
    {
      ...
      // mid-side nodes if there is any
      case 4:
        y1 = 0.;
        y2 = -1.;
        break;
          ...
          switch (node_id_2)
          {
            ...
            case 7:
            {
              dndy1_at_nodes[node_id][node_id_2] =
                0.125 * sign_node_y1 * y2_term * y3_term * y123_temp +
                0.125 * y1_term * y2_term * y3_term * sign_node_y1;
  ...
  int node_id, double& sign_node_y1, double& sign_node_y2, double& sign_node_y3)
{
  switch (node_id)
  {
    ...
    case 19:
      ...
      break;
    default:
      // Should not be possible to get here, but if we do, at least results will be consistent, not
      // random
      sign_node_y1 = 0.;
      sign_node_y2 = 0.;
      sign_node_y3 = 0.;
